...
UCLASS(abstract)
class GALAGA_USFX_LA01_API ANaveEnemiga : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	void Escapar(FVector PosicionJugador) PURE_VIRTUAL(ANaveEnemiga::Escapar, );
	void Atacar(bool bAtacar) PURE_VIRTUAL(ANaveEnemiga::Atacar, );
};
